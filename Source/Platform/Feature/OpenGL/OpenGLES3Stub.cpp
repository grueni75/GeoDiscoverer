...
GLboolean gl3stubInit() {
  glReadBuffer=(void (*)(GLenum))eglGetProcAddress("glReadBuffer");
  glMapBufferRange=(GLvoid* (*)(GLenum, GLintptr, GLsizeiptr, GLbitfield))eglGetProcAddress("glMapBufferRange");
  glUnmapBuffer=(GLboolean (*)(GLenum))eglGetProcAddress("glUnmapBuffer");
  if (!glReadBuffer ||
      !glMapBufferRange ||
      !glUnmapBuffer)
  {
